...
def test_script_help():
    ...
    assert "factotum_cli --path tests/assets/import_module.py run" in result.stdout
...
def test_script_imported_help():
    ...
    assert result.returncode == 0
    assert (
        "factotum_cli --path tests/assets/import_module.py run imported"
        in result.stdout
    )
